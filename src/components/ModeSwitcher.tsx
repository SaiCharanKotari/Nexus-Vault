...
export const ModeSwitcher: React.FC<ModeSwitcherProps> = ({ mode, setMode }) => {
  ...
  return (
    <div 
      className="absolute top-0 left-1/2 -translate-x-1/2 w-[160px] h-[80px] z-[1000] flex justify-center"
    ...
    >
      ...
      >
        ...
        <motion.div 
          ...
          className={`absolute bottom-3 flex flex-col items-center gap-0.5 transition-all duration-500 pointer-events-none ${
            isGaming ? 'text-nexus-accent translate-z-[20px]' : 'text-white/5 rotate-180 translate-z-[-20px]'
          }`}
        >
        ...
        <motion.div 
          style={{ transformStyle: 'preserve-3d' }}
          className={`absolute top-3 flex flex-col items-center gap-0.5 transition-all duration-500 pointer-events-none ${
            !isGaming ? 'text-pink-500 rotate-180 translate-z-[20px]' : 'text-white/5 translate-z-[-20px]'
          }`}
        >
